    ...
    <div class="auth-inner row m-0">
        ...
        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                ...
                <form class="auth-register-form mt-2" id="form" action="{{ route('registration') }}" method="POST">
                    <div class="mb-1">
                        <label class="form-label" for="username">Username</label>
                        <input class="form-control" id="username" type="text" name="name" placeholder="johndoe"
                    ...
                    <div class="mb-1">
                        <label class="form-label" for="password">Re-Type Your Password</label>
                        <div class="input-group input-group-merge form-password-toggle">
                    ...
                    <div class="mb-1">
                        <div class="form-check">
                            <input class="form-check-input" id="register-privacy-policy" name="register-privacy-policy"
                    ...
                    <button class="btn btn-primary w-100" id="btn_submit" type="submit" tabindex="5">Sign up</button>
                </form>
