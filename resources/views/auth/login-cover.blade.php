    ...
    <div class="auth-inner row m-0">
        ...
        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                ...
                <form class="auth-login-form mt-2" id="form" action="{{ route('authentication') }}" method="POST">
                    <div class="mb-1">
                    ...
                    <button class="btn btn-primary w-100" id="btn_submit" tabindex="4">Sign in</button>
                </form>
...
@section('page-script')
<script src="{{ asset(mix('js/pages/auth-login.js')) }}"></script>
@endsection
